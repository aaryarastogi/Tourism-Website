...
//for PNR status
app.post("/api/pnr", handlepnrPostData);
app.get("/api/pnr/:pnrNumber", handlepnrGetData);

//for live train status
app.post("/api/live-train",handleLiveTrainPostData);
app.get("/api/live-train/:number",handleLiveTrainGetData)
